...
package edu.umd.umiacs.newsstand.layers;
...
public class LayersAlertDialogFragment extends DialogFragment {
    private LayersAlertPositiveListener alertPositiveListener;

    /**
     * An interface implemented in the hosting activity for "OK" button click listener
     */
    public interface LayersAlertPositiveListener {
